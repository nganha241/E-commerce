...
class RoleDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $superAdmin = User::whereEmail('ha@gmail.com')->first();

        if (!$superAdmin) {
            $superAdmin = User::factory()->create(['email' => 'ha@gmail.com']);
        }
        ...
        $permissions = [
            ...
            ['name' => 'show-order', 'display_order' => 'Shoe order', 'group' => 'Order', 'group' => 'Order']
        ];
