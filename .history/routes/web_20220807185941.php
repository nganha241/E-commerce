...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('users')->controller(UserController::class)->name('users.')->group(function () {
        Route::get('/', 'index')->name('index')->middleware('permissions:show-user');
        Route::post('/', 'store')->name('store')->middleware('permissions:create-user');
        Route::get('/create', 'create')->name('create')->middleware('permissions:create-user');
        Route::get('/{coupon}', 'show')->name('show')->middleware('permissions:show-user');
        Route::put('/{coupon}', 'update')->name('update')->middleware('permissions:update-user');
        Route::delete('/{coupon}', 'destroy')->name('destroy')->middleware('permissions:delete-user');
        Route::get('/{coupon}/edit', 'edit')->name('edit')->middleware('permissions:update-user');
    });
