...
<head>
  ...
  <script src="https://cdn.tiny.cloud/1/qjpog61mo557zet57296t83vt760j6s7zwzd21tkiv9tmbhm/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  ...
                  <form id="dropdown-item" action="{{ route('logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
