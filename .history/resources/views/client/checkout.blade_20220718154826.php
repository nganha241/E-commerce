               ...
               <div class="block billing-details">
                  <h4 class="widget-title">Billing Details</h4>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="customer_email" value="{{$user->email}}">
                     </div>
                     <div class="form-group">
                ...
                <div class="product-checkout-details">
                    <div class="block">
                     ...
                     <div class="summary-total">
                        <span>Total</span>
                        @if ($sum > 300000)
                                <input name="total" value="{{round($sum - (session('discount_amount_price') * $sum)/100, 3)}}" class="float-lg-right text-right border-0 h5" readonly/>
                           @else
                                <input name="total" value="{{round(($sum - (session('discount_amount_price') * $sum)/100) + 30000)}}" class="float-lg-right text-right border-0 h5"  readonly/>
                           @endif
                     </div>
                  </div>
               </div>
