...
<div class="page-wrapper mt-50">
   <div class="shopping">
      <div class="container">
        <form class="checkout-form col-md-8" action="{{route('carts.process-checkout')}}" method="POST">
            @csrf
         <div class="row">
            <div class="col-md-8">
        ...
        <form class="col-md-4" action="{{route('carts.process-checkout')}}" method="POST">
         @csrf
            <div class="col-md-4">
                            ...
                            <div class="media product-card">
                                ...
                                <img class="media-object" src="{{$cart->product->image()}}" alt="Image" />
                                    ...
                                    <div class="media-body">
                                        ...
                                        <input type="text" name="product_name[]" value="{{$cart->product->name}}" hidden>
                                        </a></h4>
