                    ...
                    <div class="block">
                     ...
                     <ul class="summary-prices">
                        ...
                        <li>
                            ...
                            <span class="border-1">{{session('coupon_code')}} </span>
                        </li>
                        @endif
                     </ul>
                     <div class="summary-total">
                        <span>Total</span>
                        @if ($sum > 300000)
                                <input name="total" value="{{number_format(round($sum - (session('discount_amount_price') * $sum)/100, 3), 0, ',',',')}}"  readonly class=" border-0"/>
                           @else
