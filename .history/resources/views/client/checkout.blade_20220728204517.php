...
<div class="page-wrapper mt-50">
   <div class="shopping">
      <div class="container">
            ...
            <form class="checkout-form row" action="{{route('carts.process-checkout')}}" method="POST">
                @csrf
                        ...
                        <div class="block">
                         ...
                         <ul class="summary-prices">
                            ...
                            <li>
                               ...
                               @if ($sum > 300000)
                                    <span>Free</span>
                                    <input type="text" name="ship" value="0" hidden>
                               @else
                                    <span>30,000</span>
                                    <input type="text" name="ship" value="30000" hidden>
                               @endif
                            </li>
                            ...
                            <li>
                                ...
                                <input type="text" name="discount" value="{{round($sum - ($sum - (session('discount_amount_price') * $sum)/100), 3)}}" hidden>
