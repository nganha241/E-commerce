                ...
                <div class="product-checkout-details">
                    <div class="block">
                     ...
                     <div class="summary-total">
                        <span>Total</span>
                        @if ($sum > 300000)
                                <input name="total" value="{{round($sum - (session('discount_amount_price') * $sum)/100, 3)}}"  readonly class="float-lg-right text-right border-0 h5"/>
                           @else
                                <input name="total" value="{{number_format(round(($sum - (session('discount_amount_price') * $sum)/100) + 30000), 0, ',',',')}}"  readonly/>
                           @endif
                     </div>
                  </div>
               </div>
