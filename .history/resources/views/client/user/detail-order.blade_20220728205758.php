    ...
    <div class="container py-5">
      <div class="row d-flex justify-content-center align-items-center h-100" style="margin-top: 100px">
        <div class="col-lg-8 col-xl-6">
          <div class="card border-top border-bottom border-3 mt-50" style="border-color: #fe4c50 !important; width:100%;">
              ...
              <div class="mx-n5 px-5 py-4" style="background-color: #f2f2f2;">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-lg-3">
                            <img class="media-object" src="{{$item->products->image()}}" alt="Image" style="width: 20%"/>
                        </div>
