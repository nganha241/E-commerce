          ...
          @endif
                    ...
                    <div class="row">
                        <div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url({{$item->img}})"></div>
							</div>
						</div>
                        <div class="col-md-6">
              ...
              <div class="row my-4">
                <div class="col-md-4 offset-md-8 offset-lg-9">
                  <p class="mb-0" style="color: #fe4c50;">Ship: <span>{{number_format($order->ship,0,',',',')}}</span></p>
                  @if ($order->discount!=0)
                  <p class="mb-0" style="color: #fe4c50;">Coupon: <span>{{number_format($order->discount,0,',',',')}}</span></p>
                  @endif
                  <p class="mb-0" style="color: #fe4c50;">Total: <span>{{number_format($order->total, 0,',',',')}}</span></p>
                </div>
              </div>
