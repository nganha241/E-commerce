                        ...
                        <div class="col-md-7">
                            <div class="media-body">
                                <ul class="user-profile-list">
                                  <li><span>Full Name:</span>{{$user->product_name}}</li>
                                  <li><span>Address:</span>{{$user->product_address}}</li>
                                  <li><span>Email:</span>{{$user->product_email}}</li>
                                  <li><span>Phone:</span>{{$user->product_phone}}</li>
                                </ul>
                              </div>
                        </div>
