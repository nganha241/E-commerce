			...
			<div class="col-md-12 mt-50">
				...
				<div class="dashboard-wrapper dashboard-user-profile">
                    <div class="media">
                      ...
                      <form action="{{route('changePassword', $user->id)}}" method="POST" style="margin: 0 auto; border: 1px solid">
                        @method('put')
                        @csrf
                        <div class="media-body" >
                            <ul class="user-profile-list" >
                              ...
                              <li><span>New Password:</span><input type="text" name="password" style="height: 30px; border:1px solid"></span></li>
                              <li><span>Old Password:</span><input type="text" name="old-password" style="height: 30px; border:1px solid"></span></li>
                              <button class="btn btn-danger">Change</button>
                            </ul>
                          </div>
                      </form>
