			...
			<div class="col-md-12 mt-50">
                <div class="col-sm-2">
                    <ul class="list-group list-group-horizontal">
                        <li class="list-group-item bg-dark"><a class="active"  href="{{route('my_orders')}}">Orders</a></li>
                        <li class="list-group-item bg-dark"><a href="{{route('profile')}}">Profile Details</a></li>
                    </ul>
                </div>
