			...
			<div class="col-md-12 mt-50">
                <div class="col-sm-2">
                    <ul class="list-group list-group-horizontal">
                        <li class="list-group-item bg-light"><a class="active"  href="{{route('my_orders.index')}}">Orders</a></li>
						...
						<table class="table">
							...
							<tbody>
                                ...
                                <tr>
									...
									<td><a href="{{route('my_orders.show', $item->id)}}" class="btn btn-primary">View</a></td>
