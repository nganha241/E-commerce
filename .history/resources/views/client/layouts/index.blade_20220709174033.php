...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="{{asset('client/assets/styles/bootstrap4/bootstrap.min.css')}}"
        />
        <link
            href="{{asset('client/assets/plugins/font-awesome-4.7.0/css/font-awesome.min.css')}}"
            rel="stylesheet"
            type="text/css"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{asset('client/assets/plugins/OwlCarousel2-2.2.1/owl.carousel.css')}}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{asset('client/assets/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{asset('client/assets/plugins/OwlCarousel2-2.2.1/animate.css')}}"
        />
                ...
                <div class="col-lg-12 text-right">
                    ...
                    <nav class="navbar">
                        <ul class="navbar_menu">
                            <li><a href="#">home</a></li>
                            <li><a href="{{view('client.shop')}}">shop</a></li>
