            ...
            <div class="col">
                <div class="product-grid"  data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
                    ...
                    @foreach ($products as $key => $product)
                        ...
                        <?php echo($product->categories[$key]->name)?>
{{-- <div>dd({{$product->categories[$i]->name}})</div> --}}
                            {{-- <p>{{Str::slug($category->categories[0]->name)}}</p> --}}
                            <div class="product-item {{Str::slug($product->categories[$key]->name)}}">
