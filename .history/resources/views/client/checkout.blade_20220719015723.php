                            ...
                            <div class="media product-card">
                                ...
                                <img class="media-object" src="{{$cart->product->image()}}" alt="Image" />
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="{{route('single', $cart->product_id)}}">
                                        <input type="text" name="product_name" value="{{$cart->product->name}}" class="media-heading border-0" readonly>
                                        </a></h4>
