                ...
                <div class="product-checkout-details">
                    <div class="block">
                     ...
                     <ul class="summary-prices">
                        ...
                        <li>
                            <span>Coupon:</span>
                            <span style="color: red">-{{session('discount_amount_price')}}%</span>
                     ...
                     <div class="summary-total">
                        <span>Total</span>
                        @if ($sum > 300000)
                                <span>{{number_format(round($sum - (session('discount_amount_price') * $sum)/100, 3), 0, ',', ', ')}}</span>
                           @else
                                <span>{{number_format(round(($sum - session('discount_amount_price')) + 30000), 0, ',', ', ')}}</span>
                           @endif
                     </div>
                  </div>
               </div>
