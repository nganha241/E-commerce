...
<div class="container single_product_container">
    ...
    <form action="{{route('addCart')}}" method="post" class="single_product_pics" >
        @csrf
    <div class="row">
        <div class="col-lg-7">
                    ...
                    <div class="col-lg-3 thumbnails_col order-lg-1 order-2">
                        <div class="single_product_thumbnails">
                            <ul>
                                ...
                                <li><img src="{{$item->images->count() > 0 ? asset('/upload/imgs/' . $item->images->first()->url) : '/upload/imgs/default.jpg'}}" alt=""/></li>
                                @endforeach
            ...
            <div class="product_details">
                ...
                <div class="quantity d-flex flex-column flex-sm-row align-items-sm-center">
                    ...
                    <div class="quantity_selector">
                        ...
                        <input type="text" name="product_quantity" id="quantity_value" value="1" readonly
